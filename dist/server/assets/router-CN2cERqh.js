...
const appCss = "/assets/styles-Ctw9JT9h.css";
...
const $$splitComponentImporter$7 = () => import("./event-organizer-BEGR8WF7.js");
const Route$7 = createFileRoute("/event-organizer")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "World-class Ethiopian event organization for weddings, conferences, festivals, and cultural showcases."
    }]
  })
});
const $$splitComponentImporter$6 = () => import("./catalog-CqdQ-xC6.js");
const Route$6 = createFileRoute("/catalog")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Browse curated Ethiopia travel packages: historical, cultural, adventure, trekking, festival and Addis Ababa city tours and day trips."
    }]
  })
});
const $$splitComponentImporter$5 = () => import("./blog-C3XgHAXy.js");
const Route$5 = createFileRoute("/blog")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Read the SDF Land of Origin blog for travel stories, heritage insights, and ways to connect on WhatsApp, Facebook, YouTube, and TikTok."
    }]
  })
});
const $$splitComponentImporter$4 = () => import("./index-BMCJL7Vb.js");
const Route$4 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Explore Ethiopia with SDF Land of Origin. Curated cultural tours, heritage journeys, and event organization across the cradle of humanity."
    }]
  })
});
const $$splitComponentImporter$3 = () => import("./index-BTU5dmpx.js");
...
const $$splitComponentImporter$2 = () => import("./catalog._id-BO7IAX0a.js");
const Route$2 = createFileRoute("/catalog/$id")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./testimonials-DZGmWfPj.js");
const Route$1 = createFileRoute("/admin/testimonials")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component"),
  head: () => ({
    meta: [{
      title: "Testimonials Admin — SDF Land of Origin"
    }]
  })
});
const $$splitComponentImporter = () => import("./catalog-CSFKq_ls.js");
const Route2 = createFileRoute("/admin/catalog")({
...
const EventOrganizerRoute = Route$7.update({
  id: "/event-organizer",
...
const CatalogIdRoute = Route$2.update({
  id: "/$id",
  path: "/$id",
  getParentRoute: () => CatalogRoute
});
const AdminTestimonialsRoute = Route$1.update({
  id: "/admin/testimonials",
  path: "/admin/testimonials",
  getParentRoute: () => Route$8
});
const AdminCatalogRoute = Route2.update({
  id: "/admin/catalog",
  path: "/admin/catalog",
  getParentRoute: () => Route$8
});
